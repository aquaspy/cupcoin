...
{
    var url = admintools.ControlPanel.plugin_url + "&view=SecurityExceptions&task=getByDate&datefrom=" + admintools.ControlPanelGraphs.graph.from + "&dateto=" + admintools.ControlPanelGraphs.graph.to + "&format=json";
...
{
    var url = admintools.ControlPanel.plugin_url + "&view=SecurityExceptions&task=getByType&datefrom=" + admintools.ControlPanelGraphs.graph.from + "&dateto=" + admintools.ControlPanelGraphs.graph.to + "&format=json";
