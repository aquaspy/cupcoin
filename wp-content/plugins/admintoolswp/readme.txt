...
Admin Tools for WordPress requires PHP 5.6 or any later version. Older versions of PHP are not supported. We recommend using PHP 7.3 or later for security and performance reasons.

Admin Tools for WordPress has been tested on WordPress 4.9 and later. It should work on earlier versions of WordPress
